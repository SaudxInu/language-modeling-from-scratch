...
from cs336_basics.nn.modules.cross_entropy import cross_entropy
...
def run_multihead_self_attention(
    ...
    model.w.weight.data = torch.cat(
        [q_proj_weight, k_proj_weight, v_proj_weight], dim=0
    )
    model.o.weight.data = o_proj_weight
    out_features = model(in_features)
    return out_features
...
def run_multihead_self_attention_with_rope(
    ...
    model.o.weight.data = o_proj_weight
    out_features = model(in_features, token_positions)
    return out_features
