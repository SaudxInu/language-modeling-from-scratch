# torchrun --nnodes=1 --nproc_per_node=2 cs336_systems/ddp_overlap_individual_parameters_benchmarking.py --model_size large
# uv run nsys profile -o overlap torchrun --nnodes=1 --nproc_per_node=2 cs336_systems/ddp_overlap_individual_parameters_benchmarking.py --model_size large
import argparse
import timeit
import contextlib
...
def main(context_length, model_size, steps, nsys):
    ...
    model = DDPIndividualParameters(model, nsys)
...
if __name__ == "__main__":
    ...
    main(args.context_length, args.model_size, args.steps, args.nsys)
